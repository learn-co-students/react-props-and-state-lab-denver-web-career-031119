...
describe('<Pet />', () => {
  describe('Rendering props', () => {
    it('should render the name', () => {
      ...
      expect(wrapper.text().includes(MALE_DOG.name)).to.be.false;
    });
    ...
    it('should render the pet type', () => {
      const wrapper = shallow(<Pet pet={FEMALE_CAT} />);
      expect(wrapper.text().includes(FEMALE_CAT.type)).to.be.false;
    });

    it('should render the pet age', () => {
      const wrapper = shallow(<Pet pet={FEMALE_CAT} />);
      expect(wrapper.text().includes(FEMALE_CAT.age)).to.be.false;
    });

    it('should render the pet weight', () => {
      const wrapper = shallow(<Pet pet={FEMALE_CAT} />);
      expect(wrapper.text().includes(FEMALE_CAT.weight)).to.be.false;
    });
  });
